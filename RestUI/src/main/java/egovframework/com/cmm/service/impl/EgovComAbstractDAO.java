...
public abstract class EgovComAbstractDAO extends EgovAbstractDAO{
	...
	public List<?> list(String queryId) {
        ...
        //return SEEDUtil.decryptList(getSqlMapClientTemplate().queryForList(queryId));
    }
	...
	public List<?> list(String queryId, Object parameterObject) {
        ...
        //return SEEDUtil.decryptList(getSqlMapClientTemplate().queryForList(queryId, parameterObject));
    }
    ...
    public Object select(String queryId) {
    	...
    	if(obj instanceof Map){
    		...
    		//obj = SEEDUtil.decryptMap((Map<String,Object>)obj);
    	}
    	return obj;
    }
