...
public class EgovFileScrty {
    ...
    public static void main(String[] args) {
    	try {
			...
			LOGGER.info(password + " => " + first + " : " + checkPassword(password, first, salt.getBytes()));
			LOGGER.info(password + " => " + second + " : " + checkPassword(password, second, salt.getBytes()));
		} catch (Exception ex) {
			ex.printStackTrace();
		}
    }
